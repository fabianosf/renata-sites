...
import { facialVideos, mediaImages } from "@/config/media";
        ...
        <section className="pt-32 pb-16 bg-gradient-to-b from-primary/5 to-background">
          <div className="container mx-auto px-4 lg:px-8">
            ...
            <div className="max-w-3xl mx-auto text-center animate-fade-in">
              ...
              <h1 className="text-3xl lg:text-4xl font-medium mb-4">{t("facial.title")}</h1>
            ...
            <div className="max-w-4xl mx-auto mt-10">
              <MediaImage
                src={mediaImages.procedimentoFacial1}
                alt="Procedimento de rejuvenescimento facial na Clínica Renata Bastos"
        ...
        <section className="py-16 lg:py-20 bg-muted/30">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-5xl mx-auto">
              ...
              <VideoGallery videos={facialVideos} columns={2} />
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mb-6">
              ...
              {outrosProcedimentos.map((proc) => (
                ...
                >
                  <CardContent className="p-6">
                    <h2 className="text-xl font-medium mb-3">{proc.title}</h2>
