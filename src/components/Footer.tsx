import { Facebook, Instagram, Linkedin, Youtube, Phone, MapPin, ExternalLink, MessageCircle } from "lucide-react";
...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: Linkedin, href: siteConfig.social.linkedin.url, label: siteConfig.social.linkedin.label },
    { icon: Youtube, href: siteConfig.social.youtube.url, label: siteConfig.social.youtube.label },
  ];
    ...
    <footer className="bg-foreground text-background">
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          {/* Column 1: Brand */}
          <div>
            <Logo className="mb-4" height="h-24 md:h-28" />
