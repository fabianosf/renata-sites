...
const StructuredData = ({ type = "home", serviceId, article }: StructuredDataProps) => {
  ...
  const localBusinessSchema = useMemo(() => ({
    ...
    "@id": "https://renatabastos.com.br/#organization",
    name: siteConfig.brand.name,
    alternateName: siteConfig.brand.fullName,
    description: siteConfig.seo.description,
    url: "https://renatabastos.com.br",
    logo: "https://renatabastos.com.br/logo.png",
    image: "https://renatabastos.com.br/og-image.jpg",
  ...
  const personSchema = useMemo(() => ({
    "@context": "https://schema.org",
    "@type": "Person",
    "@id": "https://renatabastos.com.br/#person",
    ...
    image: "https://renatabastos.com.br/renata-avatar.jpg",
    url: "https://renatabastos.com.br",
    email: siteConfig.contact.email,
    telephone: siteConfig.contact.phone,
    address: {
    ...
    if (type === "service" && serviceId) {
      ...
      if (service) {
        return {
          "@context": "https://schema.org",
          "@type": "Service",
          "@id": `https://renatabastos.com.br/servico/${serviceId}`,
          name: service.title,
    ...
    if (type === "article" && article) {
      return {
        ...
        publisher: {
          ...
          logo: {
            "@type": "ImageObject",
            url: "https://renatabastos.com.br/logo.png",
          },
        },
        mainEntityOfPage: {
          "@type": "WebPage",
          "@id": `https://renatabastos.com.br/blog/${article.title.toLowerCase().replace(/\s+/g, "-").replace(/[^a-z0-9-]/g, "")}`,
        },
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Início",
        item: "https://renatabastos.com.br",
      },
        ...
        ? [
            {
              ...
              position: 2,
              name: "Serviços",
              item: "https://renatabastos.com.br/servicos",
            },
            {
              "@type": "ListItem",
              position: 3,
              name: servicesData.find(s => s.id === serviceId)?.title || "Serviço",
              item: `https://renatabastos.com.br/servico/${serviceId}`,
            },
          ]
        : []),
        ...
        ? [
            {
              ...
              position: 2,
              name: "Blog",
              item: "https://renatabastos.com.br/blog",
            },
            {
              "@type": "ListItem",
              position: 3,
              name: article.title,
              item: `https://renatabastos.com.br/blog/${article.title.toLowerCase().replace(/\s+/g, "-").replace(/[^a-z0-9-]/g, "")}`,
            },
          ]
        : []),
    ],
