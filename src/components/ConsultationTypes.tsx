...
const ConsultationTypes = () => {
  ...
  return (
    <section id="modalidades" className="py-20 lg:py-28 bg-gradient-to-b from-background to-muted/20">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Consulta Presencial */}
          <Card className="border border-primary/30 hover:border-primary transition-smooth hover:scale-[1.015] animate-fade-in shadow-elevated">
          ...
          {/* Consulta Online */}
          <Card className="border border-primary hover:border-primary transition-smooth hover:scale-[1.015] animate-fade-in shadow-elevated bg-gradient-to-br from-primary/5 to-transparent">
            <CardContent className="p-8">
              <div className="flex items-start justify-between mb-6">
        ...
        <div className="text-center mt-12 animate-fade-in">
          <div className="max-w-2xl mx-auto bg-gradient-to-br from-primary/10 to-primary/5 p-6 rounded-lg border border-primary/20">
